      ...
      <Contents>
        ...
        <MyInput>
          <TopBox>
            ...
            />
            <ErrorM>{props.inputsErrors.idError}</ErrorM>
          </TopBox>
          <TopBox>
            ...
            />
            <ErrorM>{props.inputsErrors.PwError}</ErrorM>
          </TopBox>
        </MyInput>
        ...
        <LongInput>
          ...
          />
          <ErrorM>{props.inputsErrors.TitleError}</ErrorM>
        </LongInput>
        ...
        <ContBox>
          ...
          />
          <ErrorM>{props.inputsErrors.ContentsError}</ErrorM>
        </ContBox>
